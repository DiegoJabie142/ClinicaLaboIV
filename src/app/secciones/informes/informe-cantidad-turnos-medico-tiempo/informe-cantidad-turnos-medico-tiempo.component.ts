...
@Component({
  selector: 'app-informe-cantidad-turnos-medico-tiempo',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './informe-cantidad-turnos-medico-tiempo.component.html',
  styleUrl: './informe-cantidad-turnos-medico-tiempo.component.scss'
})
export class InformeCantidadTurnosMedicoTiempoComponent {
  ...
  async obtenerInformeTurnos(fechaInicio: string, fechaFin: string): Promise<void> {
    try {
      ...
      const turnosPorEspecialista = await this.firebaseSvc.obtenerTurnosPorEspecialistaYFecha(fechaInicioDate, fechaFinDate);
